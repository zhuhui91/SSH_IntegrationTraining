		...
		<div id="rightdiv" class="">
			<div id="Content">
					...
					<div class="row4">
						<div id="clickButton" class="ax_html_button">
							<table>
								<tr>
									<td width="200px"></td>
									<td><input class="longButton" type="button" value="查询"
										onclick="toQury()" /></td>
									<td width="10px"></td>
									<td><input class="longButton" type="button" value="新增"
									     onclick="funurNew()" />
									</td>
									<td width="50px"></td>
									<td><input class="longButton" type="button"
										value="导出EXCEL" disabled="disabled" /></td>
									<td width="10px"></td>
					...
					<div id="divformIm">
						<form action="" enctype="multipart/form-data" method="post"
							...
							<div class="row">
								...
								<div class="col-md-4 ">
									<div class="ax_text_field">
										<input type="file" name="uploadFile" id="uploadFile" size="49" />
									</div>
								</div>
								<!-- 								<div class="col-md-1"> -->
							...
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-5">
									<div class="ax_text_field">
										<input class="longButton" type="submit" name="Import"
											value="导入" onclick="firmIm()" />
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-2 col-md-offset-5">
									<div class="ax_text_field">
										<input class="longButton" type="button" value="确认" />
									</div>
								</div>
								<div class="col-md-5"></div>
							</div>
							<script type="text/javascript">
								function firmIm() {
									...
									document.pImport.action = "priceManagementAction!ExcelInto.action";
									document.pImport.submit();
				...
				<div id="contentBottom">
					<div class="row10">
						<form action="" name="firmInEx" method="post">
							<input class="longButton" type="submit" value="查看导入明细"
								onclick="firmInt()" />
						</form>
						<script type="text/javascript">
							function firmInt() {

								document.firmInEx.action = "priceManagementAction!QuryInt.action";
								document.firmInEx.submit();
							}
						</script>
					</div>
					<br>
